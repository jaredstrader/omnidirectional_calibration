...
% File: main_samsung.m
%
% Description: Computes the calibration parameters for Samsung Gear 360
...
% 
% Note: 
% -> Add related subfolders to path for code to run properly.
%
...
%% Calibrate Fisheye (Samsung Gear 360)
% for i = 51:72
%   imageFileName = sprintf('SAM_00%d.JPG', i);
%   imageFileNames{i-50} = fullfile(imageFileName);
% end
% 
...
figure;
I = im2double(imread('SAM_0051.JPG'));
imshow(I);
